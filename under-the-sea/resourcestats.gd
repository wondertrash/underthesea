...
=======
	health_bg.size = Vector2(400, 30)
>>>>>>> 7afa7adc6b86d6c841d45cf460b2bdaeac0ef31b
...
=======
	health_bar.size = Vector2(400, 30)
	health_bar.color = Color(0.8, 0.2, 0.2)
	add_child(health_bar)
	hunger_bg = ColorRect.new()
	hunger_bg.position = Vector2(10, 45)
	hunger_bg.size = Vector2(400, 30)
	hunger_bg.color = Color(0.2, 0.2, 0.2)
	add_child(hunger_bg)
	hunger_bar = ColorRect.new()
	hunger_bar.position = Vector2(10, 45)
	hunger_bar.size = Vector2(400, 30)
>>>>>>> 7afa7adc6b86d6c841d45cf460b2bdaeac0ef31b
